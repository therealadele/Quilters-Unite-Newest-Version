...
const categories = ["Quilt", "Bag", "Clothes", "Decor", "Other"];
...
export default function PatternListForm() {
  ...
  const createPatternMutation = useMutation({
    mutationFn: async (data: FormData) => {
      return await apiRequest("POST", "/api/patterns", {
        name: data.patternName,
        designerName: data.designerName,
        designerId: "user-submitted",
        category: data.category,
        quiltType: data.category,
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Your pattern has been submitted and is pending approval by an administrator.",
      });
      navigate("/patterns");
    },
    onError: () => {
      toast({
        title: "Error",
        description: "Failed to submit pattern. Please try again.",
        variant: "destructive",
      });
    },
  });
  ...
  const validateForm = (): string[] => {
    const errors: string[] = [];
    if (!formData.patternName.trim()) errors.push("Pattern Name is required");
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO title="Submit a Pattern" description="Submit your quilt pattern to the Quilters Unite library." path="/patterns/new" noindex />
      <Header />
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-serif text-3xl font-semibold">{t('patternForm.title')}</h1>
                <p className="text-muted-foreground">
                  Share a quilt pattern with the community
                </p>
              </div>
            </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="patternName">
                      {t('patternForm.patternName')} <span className="text-destructive">*</span>
                    </Label>
                    <Input
                      id="patternName"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="category">
                      {t('patternForm.category')} <span className="text-destructive">*</span>
                    </Label>
                    <Select
                ...
                <div className="space-y-3 pt-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="isDesigner" className="text-sm font-normal cursor-pointer">
                      I designed this pattern and am adding it to the database for sale
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                    ...
                    <Label htmlFor="isNotDesigner" className="text-sm font-normal cursor-pointer">
                      I did not design this pattern and am adding it to the database
                    </Label>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <Textarea
                  placeholder="Add a description about this pattern..."
                  rows={4}
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              This is how the pattern will appear to others
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="border rounded-lg p-4">
              <h3 className="font-semibold text-lg">{formData.patternName || "Pattern Name"}</h3>
      ...
      <Dialog open={showLoginPrompt} onOpenChange={setShowLoginPrompt}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              You need to be signed in to publish a pattern.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
